...
const PHRASES: Record<string, string> = {
  ...
  "Contatore impulsi ON → rising edge": "ON pulse count → rising edge",
  "Contatore impulsi OFF → falling edge": "OFF pulse count → falling edge",
  ...
  "Soft start ON (ms)": "Soft start ON (ms)",
  "Soft stop OFF (ms)": "Soft stop OFF (ms)",
  Modalità: "Mode",
  Trigger: "Trigger",
